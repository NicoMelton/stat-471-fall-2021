...
ggplot(aes(x = x, y = y), data = data) +
  ...
  geom_point() +
  geom_smooth(method = "lm",
              formula = "y ~ splines::ns(x, df = 2)", # note use y and x instead of wage and age
              se = FALSE) +
  theme_bw()
...
ggplot(aes(x = x, y = y), data = data) +
  ...
  geom_point() +
  geom_smooth(method = "lm",
              formula = "y ~ splines::ns(x, df = 10)", # note use y and x instead of wage and age
              se = FALSE) +
  theme_bw()
...
ggplot(aes(x = x, y = y), data = data) +
  ...
  geom_point() +
  geom_smooth(method = "lm",
              formula = "y ~ splines::ns(x, df = 25)", # note use y and x instead of wage and age
              se = FALSE) +
  theme_bw()
...
ggplot(aes(x = x, y = y), data = data) +
  ...
  geom_point() +
  geom_smooth(method = "lm",
              formula = "y ~ splines::ns(x, df = 50)", # note use y and x instead of wage and age
              se = FALSE) +
  theme_bw()
